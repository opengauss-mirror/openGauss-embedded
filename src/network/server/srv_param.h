...
#define MAX_PARAM_RANGE_LEN (2 * GS_MAX_NUMBER_LEN + 4)
...
EXPORT_API status_t  srv_get_param(dcc_param_t param_id, param_value_t *param_value);
// only used when deployed with CM
EXPORT_API status_t srv_set_param(const char *param_name, const char *param_value);
