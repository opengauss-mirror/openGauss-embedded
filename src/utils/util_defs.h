...
// {
//     GS_RETURN_IFERR(cs_try_realloc_send_pack(pack, CM_ALIGN4(size)));
...
//         GS_THROW_ERROR_EX(ERR_VALUE_ERROR, "Convert uint64 failed, the length of text can't be larger than %u",
//             GS_MAX_NUMBER_LEN);
//         return CM_ERROR;
//     }
