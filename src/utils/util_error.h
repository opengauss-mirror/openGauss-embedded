...
typedef enum en_DCC_errno {
    ...
    ERR_DCC_INVALID_PARAMETER_NAME= 1005,
    ...
    ERR_DCC_LINE_SIZE_TOO_LONG    = DCC_ERRNO_SRV_BEGIN,
    ERR_DCC_FILE_NOT_EXIST        = 1101,
    ERR_DCC_FILE_SIZE_TOO_LARGE   = 1102,
    ERR_DCC_DUPLICATE_PARAMETER   = 1103,
