...
class Binder {
   public:
    ...
    auto BindFromClause(duckdb_libpgquery::PGList *list) -> std::unique_ptr<BoundQuerySource>;
    auto BindTableRef(const duckdb_libpgquery::PGNode &node) -> std::unique_ptr<BoundQuerySource>;
