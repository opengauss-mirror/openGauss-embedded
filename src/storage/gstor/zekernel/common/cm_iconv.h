...
#else
status_t cm_multibyte_to_widechar(iconv_t agent_env, const char *src_c, size_t src_c_size, wchar_t *dest_w,
    size_t dest_w_size, size_t *num_of_wchar);
status_t cm_widechar_to_multibyte(iconv_t agent_env, const wchar_t *src_w, size_t src_w_size, char *dest_c,
    size_t dest_c_size, size_t *num_of_char);
#endif
