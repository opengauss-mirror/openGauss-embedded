...
extern EXPORT_API cm_check_file_error_t g_check_file_error;
#ifdef _LIBAIO
#ifdef _WIN32
...
status_t cm_aio_getevents(cm_aio_lib_t *lib_ctx, cm_io_context_t ctx_id, long min_nr, long nr, cm_io_event_t *events,
    int32 *aio_ret);
