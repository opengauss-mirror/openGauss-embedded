...
typedef ssize_t (*rrecvfrom_func_t)(int socket, void *buf, size_t len, int flags, struct sockaddr *src_addr,
    socklen_t *addrlen);
...
typedef ssize_t (*rsendto_func_t)(int socket, const void *buf, size_t len, int flags, const struct sockaddr *dest_addr,
    socklen_t addrlen);
...
typedef int (*rselect_func_t)(int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, struct timeval *timeout);
...
typedef int (*rsetsockopt_func_t)(int socket, int level, int optname, const void *optval, socklen_t optlen);
typedef int (*rgetsockopt_func_t)(int socket, int level, int optname, void *optval, socklen_t *optlen);
...
static inline int32 cm_rdma_select(int32 nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds,
...
static inline int32 cm_rdma_getsockopt(socket_t socket, int32 level, int32 optname, void *optval, socklen_t *optlen)
{
...
static inline int32 cm_rdma_setsockopt(socket_t socket, int32 level, int32 optname, const void *optval, int optlen)
{
    return GS_INVALID_ID32;
}
