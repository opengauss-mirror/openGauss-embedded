...
EXPORT_API status_t cm_tzoffset2text(timezone_info_t tz, text_t *text);
EXPORT_API status_t cm_text2tzoffset(text_t *text, timezone_info_t *tz);
EXPORT_API int16 cm_get_local_tzoffset(void);

EXPORT_API int16 cm_get_db_timezone(void);
EXPORT_API void cm_set_db_timezone(timezone_info_t tz);
