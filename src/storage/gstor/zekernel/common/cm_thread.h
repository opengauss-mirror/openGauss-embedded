...
EXPORT_API status_t cm_create_thread(thread_entry_t entry, uint32 stack_size, void *argument, thread_t *thread);
EXPORT_API void cm_close_thread(thread_t *thread);
EXPORT_API void cm_close_thread_nowait(thread_t *thread);

EXPORT_API uint32 cm_get_current_thread_id();
#define CM_THREAD_ID cm_get_current_thread_id()

EXPORT_API bool32 cm_is_current_thread_closed();
EXPORT_API void cm_release_thread(thread_t *thread);
EXPORT_API long cm_get_os_thread_stack_rlimit(void);
EXPORT_API void cm_switch_stack_base(thread_t *thread, char *stack_base, char **org_base);
