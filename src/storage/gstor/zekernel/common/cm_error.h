...
typedef enum en_errno {
    ...
    // alter table error 
    ERR_COLUMN_DATA_TRUNCATED =  1122, 
    ...
    //SERVER [2800, 2899]
    ERR_SERVER_STARTED = 2800,
    ERR_SERVER_NOT_STARTED = 2801,
...
typedef status_t (*cm_error_handler)(const char *file, uint32 line, gs_errno_t code, const char *format,
    va_list args);
EXPORT_API void cm_init_error_handler(cm_error_handler handler);
EXPORT_API status_t cm_set_srv_error(const char *file, uint32 line, gs_errno_t code, const char *format, va_list args);
EXPORT_API status_t cm_set_clt_error(const char *file, uint32 line, gs_errno_t code, const char *format, va_list args);
EXPORT_API status_t cm_set_sql_error(const char *file, uint32 line, gs_errno_t code, const char *format, va_list args);
EXPORT_API status_t cm_set_plc_error(const char *file, uint32 line, gs_errno_t code, const char *format, va_list args);
EXPORT_API void cm_reset_error_user(int err_no, char *user, char *name, err_object_t type);
EXPORT_API void cm_set_error_loc(source_location_t loc);
EXPORT_API int32 cm_get_error_code();
EXPORT_API void cm_try_set_error_loc(source_location_t loc);
EXPORT_API void cm_get_error(int32 *code, const char **message, source_location_t *loc);
EXPORT_API void cm_reset_error();
EXPORT_API void cm_revert_pl_last_error();
EXPORT_API void cm_set_ignore_log(bool8 is_ignore_log);
EXPORT_API status_t cm_revert_error(int32 code, const char *message, source_location_t *loc);
EXPORT_API error_info_t *cm_error_info(void);

/* convert text to string, the buf in thread local storage */
EXPORT_API char *cm_get_t2s_addr();
EXPORT_API char *cm_t2s(const char *buf, uint32 len);
EXPORT_API char *cm_concat_t2s(const char *buf1, uint32 len1, const char *buf2, uint32 len2, char c_mid);
EXPORT_API char *cm_t2s_ex(const char *buf, uint32 len);
EXPORT_API char *cm_t2s_case(const char *buf, uint32 len, bool32 case_sensitive);
EXPORT_API int cm_get_os_error();
EXPORT_API int cm_get_sock_error();
EXPORT_API void cm_set_sock_error(int32 e);
...
typedef int errno_t;
#endif
EXPORT_API const char *cm_get_errormsg(int32 code);
...
extern EXPORT_API const char *g_error_desc[];
...
EXPORT_API void cm_set_error(const char *file, uint32 line, gs_errno_t code, const char *format, ...) GS_CHECK_FMT(4, 5);
EXPORT_API void cm_set_hint(const char *format, ...) GS_CHECK_FMT(1, 2);
EXPORT_API void cm_set_error_ex(const char *file, uint32 line, gs_errno_t code, const char *format, ...) GS_CHECK_FMT(4, 5);
EXPORT_API status_t cm_set_superposed_plc_loc(source_location_t loc, gs_errno_t code, const char *log_msg);
EXPORT_API void cm_reset_error_loc();
EXPORT_API void cm_log_protocol_error();
#ifdef __cplusplus
}
#endif
#endif
