...
static inline bool32 cm_text_str_equal_ignore_case(const text_t *text, const char *str)
{
    uint32 i;

    for (i = 0; i < text->len; i++) {
        if (LOWER(text->str[i]) != LOWER(str[i]) || str[i] == '\0') {
            return GS_FALSE;
        }
    }
...
EXPORT_API status_t cm_text2str(const text_t *text, char *buf, uint32 buf_size);
EXPORT_API status_t cm_text2str_with_quato(const text_t *text, char *buf, uint32 buf_size);
EXPORT_API void cm_text2str_with_upper(const text_t *text, char *buf, uint32 buf_size);
EXPORT_API status_t cm_text2bool(const text_t *text, bool32 *val);
EXPORT_API status_t cm_text2real(const text_t *text, double *value);
EXPORT_API status_t cm_text2uint16(const text_t *text, uint16 *value);
EXPORT_API status_t cm_text2int(const text_t *text, int32 *value);
EXPORT_API status_t cm_text2uint32(const text_t *text, uint32 *value);
EXPORT_API status_t cm_text2uint64(const text_t *text, uint64 *value);
EXPORT_API status_t cm_text2bigint(const text_t *text, int64 *value);
...
EXPORT_API num_errno_t cm_text2int_ex(const text_t *text_src, int32 *value);
EXPORT_API num_errno_t cm_text2uint32_ex(const text_t *text_src, uint32 *value);
EXPORT_API num_errno_t cm_text2bigint_ex(const text_t *num_text, int64 *value);
EXPORT_API num_errno_t cm_text2uint64_ex(const text_t *num_text, uint64 *value);
EXPORT_API num_errno_t cm_text2real_ex(const text_t *text_src, double *value);
EXPORT_API num_errno_t cm_text2int16_ex(const text_t *text, int32 *val);

/** Try convert a number parts (a struct for processed numeric text) into a navie datatype */
EXPORT_API num_errno_t cm_numpart2int(num_part_t *np, int32 *value);
EXPORT_API num_errno_t cm_numpart2bigint(const num_part_t *np, int64 *value);
EXPORT_API num_errno_t cm_numpart2uint32(const num_part_t *np, uint32 *value);
EXPORT_API num_errno_t cm_numpart2uint64(const num_part_t *np, uint64 *value);
EXPORT_API num_errno_t cm_numpart2real(num_part_t *np, double *value);
EXPORT_API num_errno_t cm_numpart2size(const num_part_t *np, int64 *value);

EXPORT_API status_t cm_str2uint16(const char *str, uint16 *value);
EXPORT_API status_t cm_str2uint32(const char *str, uint32 *value);
EXPORT_API status_t cm_str2uint64(const char *str, uint64 *value);
EXPORT_API status_t cm_str2int(const char *str, int32 *value);
EXPORT_API status_t cm_str2bigint(const char *str, int64 *value);
EXPORT_API status_t cm_str2real(const char *str, double *value);
EXPORT_API bool32 cm_str2real_ex(const char *str, double *val);
EXPORT_API uint32 cm_bool2str(bool32 value, char *str);
EXPORT_API void cm_split_text(const text_t *text, char split_char, char enclose_char, text_t *left, text_t *right);
EXPORT_API bool32 cm_split_rtext(const text_t *text, char split_char, char enclose_char, text_t *left, text_t *right);
EXPORT_API bool32 cm_is_short(const text_t *text);
EXPORT_API bool32 cm_is_int(const text_t *text);
EXPORT_API bool32 cm_is_bigint(const text_t *text, num_part_t *np);

EXPORT_API num_errno_t cm_decide_numtype(const num_part_t *np, gs_type_t *type);

EXPORT_API num_errno_t cm_is_number(const text_t *text, gs_type_t *type);
EXPORT_API num_errno_t cm_is_number_with_sign(const text_t *text, gs_type_t *type);
EXPORT_API bool32 cm_is_unsigned_int(const char *str);
EXPORT_API void cm_truncate_text(text_t *text, uint32 max_len);
EXPORT_API void cm_trim_number(text_t *text, bool32 has_dot);
EXPORT_API status_t cm_text2size(const text_t *text, int64 *value);
EXPORT_API status_t cm_text2microsecond(const text_t *text, uint64 *value);
EXPORT_API status_t cm_str2size(const char *str, int64 *value);
EXPORT_API status_t cm_str2microsecond(const char *str, uint64 *value);
EXPORT_API bool32 cm_fetch_text(text_t *text, char split_char, char enclose_char, text_t *sub);
EXPORT_API bool32 cm_fetch_rtext(text_t *text, char split_char, char enclose_char, text_t *sub);
EXPORT_API bool32 cm_is_enclosed(const text_t *text, char enclosed_char);
EXPORT_API bool32 cm_fetch_line(text_t *text, text_t *line, bool32 eof);

EXPORT_API void cm_str_upper(char *str);
EXPORT_API void cm_str_lower(char *str);
EXPORT_API void cm_text_upper(text_t *text);
EXPORT_API void cm_text_lower(text_t *text);
EXPORT_API void cm_text_upper_self_name(text_t *name);
EXPORT_API void cm_str_reverse(char *dst, const char *src, uint32 dst_len);
EXPORT_API size_t cm_str_diff_chars(const char *src, const char *dst);
EXPORT_API uint32 cm_instrb(const text_t *str, const text_t *substr, int32 pos, uint32 nth);
EXPORT_API status_t cm_substrb(const text_t *src, int32 start, uint32 size, text_t *dst);

EXPORT_API char *cm_strchr(const text_t *str, const int32 c);
EXPORT_API status_t cm_replace_regexp_spec_chars(text_t *regexp, char *ret, uint32 ret_size);
EXPORT_API status_t cm_str2bool(const char *bool_str, bool32 *val);
