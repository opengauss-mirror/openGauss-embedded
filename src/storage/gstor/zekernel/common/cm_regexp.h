...
typedef struct st_regexp_args {
    ...
    int32 retopt; // specifies whether to return start position(0) or end position(1) after the pattern matched, default
                  // is 0
    int32 subexpr; // specifies which capture group of the pattern-expression is used to determine the position within
                   // source-string to return, default is 0
