...
EXPORT_API log_param_t *cm_log_param_instance();
EXPORT_API void cm_log_set_session_id(uint32 sess_id);
EXPORT_API void cm_log_init(log_id_t log_id, const char *file_name);
EXPORT_API void cm_log_set_path_permissions(uint16 val);
EXPORT_API void cm_log_set_file_permissions(uint16 val);
EXPORT_API void cm_log_open_file(log_file_handle_t *log_file_handle);
EXPORT_API status_t cm_log_get_bak_file_list(char *backup_file_name[GS_MAX_LOG_FILE_COUNT], uint32 *backup_file_count, const char *log_file);

EXPORT_API void cm_write_optinfo_log(const char *format, ...) GS_CHECK_FMT(1, 2);
EXPORT_API void cm_write_longsql_log(const char *format, ...) GS_CHECK_FMT(1, 2);
EXPORT_API void cm_write_max_longsql_log(const char *format, ...) GS_CHECK_FMT(1, 2);
EXPORT_API void cm_write_audit_log(const char *format, ...) GS_CHECK_FMT(1, 2);
EXPORT_API void cm_write_alarm_log(uint32 warn_id, const char *format, ...) GS_CHECK_FMT(2, 3);
EXPORT_API void cm_write_alarm_log_cn(uint32 warn_id, const char *format, ...) GS_CHECK_FMT(2, 3);
EXPORT_API void cm_write_blackbox_log(const char *format, ...) GS_CHECK_FMT(1, 2);

EXPORT_API void cm_write_normal_log(log_id_t log_id, log_level_t log_level, const char *code_file_name, uint32 code_line_num,
                                    const char *module_name, bool32 need_rec_filelog, const char *format, ...) GS_CHECK_FMT(7, 8);
EXPORT_API void cm_write_oper_log(char *buf, uint32 len);
EXPORT_API void cm_write_trace_log(const char *format, ...);
EXPORT_API void cm_fync_logfile();
EXPORT_API void cm_write_pe_oper_log(char *buf, uint32 len);
EXPORT_API void cm_print_call_link(uint32 stack_depth);
EXPORT_API void cm_log_allinit();
...
#define PRINT_BUF_INFO(ptr, len) GS_LOG_RUN_INF("" #ptr "  = %p , len=%d", ptr, len)
