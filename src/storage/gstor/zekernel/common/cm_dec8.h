 ...
 * -------------------------------------------------------------------------
 */
#ifndef __CM_DEC8_H__
#define __CM_DEC8_H__
#include "cm_dec4.h"
...
EXPORT_API status_t cm_dec8_finalise(dec8_t *dec, uint32 prec, bool32 allow_overflow);
...
EXPORT_API status_t cm_dec8_divide(const dec8_t *dec1, const dec8_t *dec2, dec8_t *result);
EXPORT_API status_t cm_adjust_dec8(dec8_t *dec, int32 precision, int32 scale);
EXPORT_API status_t cm_adjust_dec8_with_mode(dec8_t *dec, int32 precision, int32 scale, round_mode_t rnd_mode);
 ...
 */
EXPORT_API status_t cm_dec8_add_op(const dec8_t *d1, const dec8_t *d2, dec8_t *rs);
EXPORT_API status_t cm_dec8_sub_op(const dec8_t *dec1, const dec8_t *dec2, dec8_t *result);
EXPORT_API status_t cm_dec8_mul_op(const dec8_t *d1, const dec8_t *d2, dec8_t *rs);
