...
#define IS_GBK_SPECIAL_HALF_CHARACTER(a)                                                                   \
    (((a) == 0x20) || ((a) == 0x22) || ((a) == 0x24) || ((a) == 0x27) || ((a) == 0x5E) || ((a) == 0x60) || \
        ((a) == 0x7E))
#define IS_GBK_SPECIAL_FULL_CHARACTER(a, b)                                                              \
    (GBK_FULL_BLANK_SPACE(a, b) || GBK_FULL_DOUBLE_QUOTATION(a, b) || GBK_FULL_SINGLE_QUOTATION(a, b) || \
        GBK_FULL_DOLLAR(a, b) || GBK_FULL_CARET(a, b) || GBK_FULL_APOSTROPHE(a, b) || GBK_FULL_TILDE(a, b))
...
#define GBK_FULL_OTHER(a, b)                                                                        \
    (((a)&0xFF) == 0xA3 && ((((b)&0xFF) == 0xA1) || (((b)&0xFF) == 0xA3) ||                         \
        (((b)&0xFF) >= 0xA5 && ((b)&0xFF) <= 0xA6) || (((b)&0xFF) >= 0xA8 && ((b)&0xFF) <= 0xDD) || \
        (((b)&0xFF) == 0xDF) || (((b)&0xFF) >= 0xE1 && ((b)&0xFF) <= 0xFD)))
#define GBK_HALF_OTHER(a)                                                                              \
    (((a) == 0x21) || ((a) == 0x23) || ((a) >= 0x25 && (a) <= 0x26) || ((a) >= 0x28 && (a) <= 0x5D) || \
...
status_t cm_gbk_text_like_escape(char *str, const char *str_end, char *wildstr, const char *wildend, char escape,
    int32 *cmp_ret);
