...
{
    if (cm_str_equal(client_ip, "127.0.0.1") || cm_str_equal(client_ip, "::1") ||
...
EXPORT_API status_t cm_ipport_to_sockaddr(const char *host, int port, sock_addr_t *sock_addr);
EXPORT_API status_t cm_ip_to_sockaddr(const char *host, sock_addr_t *sock_addr);
EXPORT_API bool32 cm_check_ip_valid(const char *ip);
EXPORT_API status_t cm_parse_cidrs(text_t *cidr_texts, list_t *cidr_list);
EXPORT_API status_t cm_str_to_cidr(char *cidr_str, cidr_t *cidr, uint32 cidr_str_len);
EXPORT_API bool32 cm_check_ip(white_context_t *ctx, const char *ip_str, const char *user, bool32 *hostssl);
EXPORT_API status_t cm_ip_in_cidr(const char *ip_str, cidr_t *cidr, bool32 *result);
EXPORT_API extern status_t cm_cidr_equals_cidr(cidr_t *cidr1, cidr_t *cidr2, bool32 *result);
EXPORT_API status_t cm_check_remote_ip(white_context_t *ctx, const char *ip_str, bool32 *check_res);
EXPORT_API status_t cm_verify_lsnr_addr(const char *ipaddrs, uint32 len, uint32 *ip_cnt);
EXPORT_API status_t cm_split_host_ip(char host[][CM_MAX_IP_LEN], const char *value);
EXPORT_API bool32 cm_check_user(white_context_t *ctx, const char *ip_str, const char *user, bool32 *hostssl);
