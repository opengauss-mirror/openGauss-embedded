...
void print_btree_init_segment(log_entry_t *log)
{
    ...
    printf("uid %u, table_id %u, index_id %u, space %u, initrans %u, pctfree %u, "
        ...
        seg->uid, seg->table_id, seg->index_id, seg->space_id, seg->initrans, seg->pctfree, seg->org_scn, seg->seg_scn,
        seg->cr_mode);
    ...
    printf("extents(count %u, first %u-%u, last %u-%u), ufp_count %u, ufp_first %u-%u, ufp_extent %u-%u, ",
        ...
        (uint32)seg->extents.last.file, (uint32)seg->extents.last.page, seg->ufp_count, (uint32)seg->ufp_first.file,
        (uint32)seg->ufp_first.page, (uint32)seg->ufp_extent.file, (uint32)seg->ufp_extent.page);
...
void print_btree_format_page(log_entry_t *log)
{
    ...
    printf("cr_mode %u seg_scn %llu level %u page_id %u-%u itls %u extent_size %u reserve_ext %u\n",
        (uint32)redo->cr_mode, redo->seg_scn, (uint32)redo->level, (uint32)redo->page_id.file,
        (uint32)redo->page_id.page, (uint32)redo->itls, (uint32)redo->extent_size, (uint32)redo->reserve_ext);
}
...
void print_btree_insert(log_entry_t *log)
{
    ...
    printf("heap_page %u-%u, heap_slot %u, undo_page %u-%u, undo_slot %u\n", (uint32)key->rowid.file,
        (uint32)key->rowid.page, (uint32)key->rowid.slot, (uint32)key->undo_page.file, (uint32)key->undo_page.page,
        (uint32)key->undo_slot);
}
...
void print_btree_reuse_itl(log_entry_t *log)
{
    ...
    printf("itl_id %u, xmap %u-%u, xnum %u, min_scn %llu\n", (uint32)redo->itl_id, (uint32)redo->xid.xmap.seg_id,
        (uint32)redo->xid.xmap.slot, redo->xid.xnum, (uint64)redo->min_scn);
}
...
void print_btree_clean_itl(log_entry_t *log)
{
    ...
    printf("itl_id %u, scn %llu, is_owscn %u, is_copied %u\n", (uint32)redo->itl_id, redo->scn, (uint32)redo->is_owscn,
        (uint32)redo->is_copied);
}
...
void print_btree_undo_insert(log_entry_t *log)
{
    ...
    printf("heap_page %u-%u, heap_slot %u, undo_page %u-%u, undo_slot %u\n", (uint32)redo->rowid.file,
        (uint32)redo->rowid.page, (uint32)redo->rowid.slot, (uint32)redo->undo_page.file, (uint32)redo->undo_page.page,
        (uint32)redo->undo_slot);
}
...
void print_btree_change_chain(log_entry_t *log)
{
    ...
    printf("prev_page %u-%u, next_page %u-%u\n", (uint32)prev->file, (uint32)prev->page, (uint32)next->file,
        (uint32)next->page);
}
