...
typedef enum en_sys_partobject_column {
    ...
    SYS_PARTOBJECT_COL_AUTO_ADDPART = 12,
    SYS_PARTOBJECT_COL_IS_CORSSPART = 13,
...
typedef enum en_sys_login_user_column {
    SYS_LOGIN_USER_COL_USERNAME_ID = 0,
    SYS_LOGIN_USER_COL_PASSWORD_ID = 1,
 
    SYS_LOGIN_USER_COLUMN_COUNT,    // systable column count, must be the last in the struct.
} sys_login_user_column_t;

#define IX_SYS_LOGIN_USER001_ID 0
