...
typedef enum en_sys_table_column {
    ...
    SYS_TABLE_COL_TIMESCALE = 27,
    SYS_TABLE_COL_RETENTION = 28,
    SYS_TABLE_COL_EX_FLAG = 29,
...
#define IX_SYS_TRIGGER_001_ID                        1
#define IX_SYS_TRIGGER_001_ID_OBJ                    0

#define IX_SYS_TRIGGERS_002_ID                        0
