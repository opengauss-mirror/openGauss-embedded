...
#define DEFAULT_CTRL_FILE 1
#define DEFAULT_USER_FILE 1
#define DEFAULT_SWAP_FILE 2

#define SYS_COL_COUNT(SYS_COLS)       (sizeof(SYS_COLS) / sizeof(column_def_t))
#define SYS_IDX_COL_COUNT(SYS_IDX_COLS) (sizeof(SYS_IDX_COLS) / sizeof(text_t))

const text_t g_user = { (char*)"SYS", 3 };
static const text_t g_db   = { (char*)"DCC_DB", 6 };
static const text_t SEQ_OBJECT_ID = { (char *)"OBJECT_ID$", 10 };
static const int64 SEQ_OBJECT_ID_STEP = 1;
static const int64 SEQ_OBJECT_ID_MINVALUE = 1;
...
// SYS_COMMENT
column_def_t g_sys_comment_cols[] = {
    { {.str = (char*)"USER#",      .len = 5  }, GS_TYPE_INTEGER, 4,     GS_FALSE },
    { {.str = (char*)"TABLE#",     .len = 6  }, GS_TYPE_INTEGER, 4,     GS_FALSE },
    { {.str = (char*)"COLUMN#",    .len = 7  }, GS_TYPE_INTEGER, 4,     GS_FALSE },
    { {.str = (char*)"COMMENT#",   .len = 8  }, GS_TYPE_VARCHAR, 4000,  GS_FALSE }
};

text_t g_sys_comment_idx01_cols[] = {
    {.str = (char*)"USER#",   .len = 5 },
    {.str = (char*)"TABLE#",  .len = 6 },
    {.str = (char*)"COLUMN#", .len = 7 }
};

#define SYS_COMMENT_COL_COUNT       (sizeof(g_sys_comment_cols) / sizeof(column_def_t))
#define SYS_COMMENT_IDX01_COL_COUNT (sizeof(g_sys_comment_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_comment_indexes[] = {
    { {.str = (char*)"IX_SYS_COMMENT$001", .len = 18 }, g_sys_comment_idx01_cols, SYS_COMMENT_IDX01_COL_COUNT, GS_TRUE }
};

// SYS_SEQUENCE
column_def_t g_sys_sequence_cols[] = {
    { {.str = (char*)"UID",          .len = 3  }, GS_TYPE_INTEGER,   4,      GS_FALSE },
    { {.str = (char*)"ID",           .len = 2  }, GS_TYPE_INTEGER,   4,      GS_FALSE },
    { {.str = (char*)"NAME",         .len = 4  }, GS_TYPE_VARCHAR,   64,     GS_FALSE },
    { {.str = (char*)"MINVALUE",     .len = 8  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"MAXVALUE",     .len = 8  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"STEP",         .len = 4  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"CACHESIZE",    .len = 9  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"CYCLE_FLAG",   .len = 10 }, GS_TYPE_INTEGER,   4,      GS_FALSE },
    { {.str = (char*)"ORDER_FLAG",   .len = 10 }, GS_TYPE_INTEGER,   4,      GS_FALSE },
    { {.str = (char*)"ORG_SCN",      .len = 7  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"CHG_SCN",      .len = 7  }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"LAST_NUMBER",  .len = 11 }, GS_TYPE_BIGINT,    8,      GS_TRUE  },
    { {.str = (char*)"DIST_DATA",    .len = 9  }, GS_TYPE_VARCHAR,   1024,   GS_FALSE },
    { {.str = (char*)"COLUMN_COUNT", .len = 12 }, GS_TYPE_INTEGER,   4,      GS_FALSE }
};

text_t g_sys_sequence_idx01_cols[] = {
    {.str = (char *)"UID", .len = 3},
    {.str = (char *)"NAME", .len = 4}
};

#define SYS_SEQUENCE_COL_COUNT (sizeof(g_sys_sequence_cols) / sizeof(column_def_t))
#define SYS_SEQUENCE_IDX01_COL_COUNT (sizeof(g_sys_sequence_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_sequence_indexes[] = {
    {{.str = (char *)"IX_SYS_SEQUENCE$001", .len = 19}, g_sys_sequence_idx01_cols, SYS_SEQUENCE_IDX01_COL_COUNT, GS_TRUE}
};
...
// SYS_VIEWCOL
column_def_t g_sys_viewcol_cols[] = {
    { {.str = (char*)"USER_ID",   .len = 7 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"VIEW_ID",   .len = 7 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"ID",        .len = 2 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"NAME",      .len = 4 }, GS_TYPE_VARCHAR,   64,    GS_FALSE },
    { {.str = (char*)"DATATYPE",  .len = 8 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"BYTES",     .len = 5 }, GS_TYPE_INTEGER,   4,     GS_TRUE  },
    { {.str = (char*)"PRECISION", .len = 9 }, GS_TYPE_INTEGER,   4,     GS_TRUE  },
    { {.str = (char*)"SCALE",     .len = 5 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"NULLABL",   .len = 7 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"FLAGS",     .len = 5 }, GS_TYPE_INTEGER,   4,     GS_FALSE }
};

text_t g_sys_viewcol_idx01_cols[] = {
    {.str = (char*)"USER_ID",  .len = 7 },
    {.str = (char*)"VIEW_ID",  .len = 7 },
    {.str = (char*)"ID",       .len = 2 },
};

#define SYS_VIEWCOL_COL_COUNT          (sizeof(g_sys_viewcol_cols) / sizeof(column_def_t))
#define SYS_VIEWCOL_IDX01_COL_COUNT    (sizeof(g_sys_viewcol_idx01_cols) / sizeof(text_t)) 

static index_def_t g_sys_viewcol_indexes[] = {
    { {.str = (char*)"IX_VIEWCOL$001", .len = 14 }, g_sys_viewcol_idx01_cols, SYS_VIEWCOL_IDX01_COL_COUNT, GS_TRUE }    
};
...
static index_def_t g_object_privs_indexes[] = {
    {{.str = (char *)"IX_OBJECT_PRIVS$_001", .len = 20},
        g_object_privs_idx01_cols,
        OBJECT_PRIVS_IDX01_COL_COUNT,
        GS_TRUE},
    {{.str = (char *)"IX_OBJECT_PRIVS$_002", .len = 20},
        g_object_privs_idx02_cols,
        OBJECT_PRIVS_IDX02_COL_COUNT,
        GS_FALSE},
    {{.str = (char *)"IX_OBJECT_PRIVS$_004", .len = 20},
...
// SYS_TRIGGER
column_def_t g_sys_trigger_cols[] = {
    { {.str = (char*)"OBJ",          .len = 3 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"TYPE",         .len = 4 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"EVENT",        .len = 5 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"OBJECTUID",    .len = 9 },  GS_TYPE_VARCHAR,   64,    GS_FALSE },
    { {.str = (char*)"BASEOBJECT",   .len = 10 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"WHENCLAUSE",   .len = 10 }, GS_TYPE_INTEGER,   4,     GS_TRUE  },
    { {.str = (char*)"ENABLE",       .len = 6 },  GS_TYPE_INTEGER,   4,     GS_TRUE  },
    { {.str = (char*)"FLAGS",        .len = 5 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"TABNAMELINE",  .len = 11 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"ACTIONLINENO", .len = 12 }, GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"ACTIONCOLNO",  .len = 11 }, GS_TYPE_INTEGER,   4,     GS_TRUE  },
    { {.str = (char*)"SPARE1",       .len = 6 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"SPARE2",       .len = 6 },  GS_TYPE_INTEGER,   4,     GS_FALSE },
    { {.str = (char*)"SPARE3",       .len = 6 },  GS_TYPE_INTEGER,   4,     GS_FALSE }, 
    { {.str = (char*)"SPARE4",       .len = 6 },  GS_TYPE_INTEGER,   4,     GS_FALSE },       
};

text_t g_sys_trigger_idx02_cols[] = {
    {.str = (char*)"OBJ",        .len = 3 },
    {.str = (char*)"OBJECTUID",  .len = 9 },
    {.str = (char*)"BASEOBJECT", .len = 10 },   
};

#define SYS_TRIGGER_COL_COUNT          (sizeof(g_sys_trigger_cols) / sizeof(column_def_t))
#define SYS_TRIGGER_IDX02_COL_COUNT    (sizeof(g_sys_trigger_idx02_cols) / sizeof(text_t)) 

static index_def_t g_sys_trigger_indexes[] = {
    { {.str = (char*)"IX_TRIGGER$001", .len = 14 }, g_sys_trigger_idx02_cols, SYS_TRIGGER_IDX02_COL_COUNT, GS_TRUE }    
};

// SYS_PARTOBJECT
column_def_t g_sys_partobject_cols[] = {
    { {.str = (char*)"USER#",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_USER_ID
    { {.str = (char*)"TABLE#",      .len = 6  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_TABLE_ID
    { {.str = (char*)"INDEX_ID",    .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_INDEX_ID
    { {.str = (char*)"PARTTYPE",    .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_PARTTYPE
    { {.str = (char*)"PARTCNT",     .len = 7  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_PARTCNT
    { {.str = (char*)"PARTKEYS",    .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_PARTKEYS
    { {.str = (char*)"FLAGS",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_FLAGS
    { {.str = (char*)"INTERVAL",    .len = 8  }, GS_TYPE_VARCHAR,   64,     GS_TRUE }, // SYS_PARTOBJECT_COL_INTERVAL
    { {.str = (char*)"BINTERVAL",   .len = 9  }, GS_TYPE_BINARY,    4000,   GS_TRUE }, // SYS_PARTOBJECT_COL_BINTERVAL
    { {.str = (char*)"SUBPARTKEYS", .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_SUBPARTKEYS
    { {.str = (char*)"SUBPARTTYPE", .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_SUBPARTTYPE
    { {.str = (char*)"SLICE",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTOBJECT_COL_IS_SLICE
    { {.str = (char*)"AUTO_ADDPART",.len = 12 }, GS_TYPE_INTEGER,   4,      GS_TRUE }, // SYS_PARTOBJECT_COL_AUTO_ADDPART
    { {.str = (char*)"IS_CROSSPART",.len = 12 }, GS_TYPE_INTEGER,   4,      GS_TRUE } // SYS_PARTOBJECT_COL_IS_CORSSPART
};

text_t g_sys_partobject_idx01_cols[] = {
    {.str = (char*)"USER#",        .len = 5  },
    {.str = (char*)"TABLE#",       .len = 6  },
    {.str = (char*)"INDEX_ID",     .len = 8  }
};

#define SYS_PARTOBJECT_COL_COUNT       (sizeof(g_sys_partobject_cols) / sizeof(column_def_t))
#define SYS_PARTOBJECT_IDX01_COL_COUNT (sizeof(g_sys_partobject_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_partobject_indexes[] = {
    {{.str = (char *)"IX_SYS_PARTOBJECT001_ID", .len = 19},
        g_sys_partobject_idx01_cols,
        SYS_PARTOBJECT_IDX01_COL_COUNT,
        GS_TRUE}};


// SYS_PARTSTORE
column_def_t g_sys_partstore_cols[] = {
    { {.str = (char*)"USER#",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTSTORE_COL_USER_ID
    { {.str = (char*)"TABLE#",      .len = 6  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTSTORE_COL_TABLE_ID
    { {.str = (char*)"INDEX_ID",    .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTSTORE_COL_INDEX_ID
    { {.str = (char*)"POSITION_ID", .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTSTORE_COL_POSITION_ID
    { {.str = (char*)"SPACE",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE } // SYS_PARTSTORE_COL_SPACE_ID
};

text_t g_sys_partstore_idx01_cols[] = {
    {.str = (char*)"USER#",        .len = 5  },
    {.str = (char*)"TABLE#",       .len = 6  },
    {.str = (char*)"INDEX_ID",     .len = 8  }
};

#define SYS_PARTSTORE_COL_COUNT       (sizeof(g_sys_partstore_cols) / sizeof(column_def_t))
#define SYS_PARTSTORE_IDX01_COL_COUNT (sizeof(g_sys_partstore_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_partstore_indexes[] = {
    {{.str = (char *)"IX_SYS_PARTSTORE001_ID", .len = 19},
        g_sys_partstore_idx01_cols,
        SYS_PARTSTORE_IDX01_COL_COUNT,
        GS_TRUE}};

// SYS_PARTCOLUMN
column_def_t g_sys_partcolumn_cols[] = {
    { {.str = (char*)"USER#",       .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTCOLUMN_COL_USER_ID
    { {.str = (char*)"TABLE#",      .len = 6  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTCOLUMN_COL_TABLE_ID
    { {.str = (char*)"COLUMN_ID",   .len = 9  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTCOLUMN_COL_COLUMN_ID
    { {.str = (char*)"POSITION_ID", .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_PARTCOLUMN_COL_POSITION
    { {.str = (char*)"DATATYPE",    .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE } // SYS_PARTCOLUMN_COL_DATATYPE
};

text_t g_sys_partcolumn_idx01_cols[] = {
    {.str = (char*)"USER#",        .len = 5  },
    {.str = (char*)"TABLE#",       .len = 6  }
};

#define SYS_PARTCOLUMN_COL_COUNT       (sizeof(g_sys_partcolumn_cols) / sizeof(column_def_t))
#define SYS_PARTCOLUMN_IDX01_COL_COUNT (sizeof(g_sys_partcolumn_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_partcolumn_indexes[] = {
    {{.str = (char *)"IX_SYS_PARTCOLUMN001_ID", .len = 19},
        g_sys_partcolumn_idx01_cols,
        SYS_PARTCOLUMN_IDX01_COL_COUNT,
        GS_TRUE}};

// SYS_COMPRESS
column_def_t g_sys_compress_cols[] = {
    { {.str = (char*)"ORGSCN",       .len = 6  }, GS_TYPE_BIGINT,    8,      GS_FALSE }, // SYS_COMPRESS_COL_ORGSCN
    { {.str = (char*)"ALGO",         .len = 4  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_COMPRESS_COL_ALGO
    { {.str = (char*)"OBJECT_TYPE",  .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE } // SYS_COMPRESS_COL_OBJECT_TYPE
};

text_t g_sys_compress_idx01_cols[] = {
    {.str = (char*)"ORGSCN",        .len = 6  }
};

#define SYS_COMPRESS_COL_COUNT       (sizeof(g_sys_compress_cols) / sizeof(column_def_t))
#define SYS_COMPRESS_IDX01_COL_COUNT (sizeof(g_sys_compress_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_compress_indexes[] = {
    {{.str = (char *)"IX_SYSCOMPRESS001_ID", .len = 19},
        g_sys_compress_idx01_cols,
        SYS_COMPRESS_IDX01_COL_COUNT,
        GS_TRUE}};

// SYS_INDEXPART
column_def_t g_sys_indexpart_cols[] = {
    { {.str = (char*)"USER#",             .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_USER_ID
    { {.str = (char*)"TABLE#",            .len = 6  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_TABLE_ID
    { {.str = (char*)"INDEX_ID",          .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_INDEX_ID
    { {.str = (char*)"PART_ID",           .len = 7  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_PART_ID
    { {.str = (char*)"NAME",              .len = 4  }, GS_TYPE_VARCHAR,   64,     GS_FALSE }, // SYS_INDEXPART_COL_NAME
    { {.str = (char*)"HIBOUNDLEN",        .len = 10 }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_HIBOUNDLEN
    { {.str = (char*)"HIBOUNDVAL",        .len = 10 }, GS_TYPE_VARCHAR,   4000,   GS_FALSE }, // SYS_INDEXPART_COL_HIBOUNDVAL
    { {.str = (char*)"SPACE",             .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_SPACE_ID
    { {.str = (char*)"ORG_SCN",           .len = 7  }, GS_TYPE_BIGINT,    8,      GS_FALSE }, // SYS_INDEXPART_COL_ORG_SCN
    { {.str = (char*)"ENTRY",             .len = 5  }, GS_TYPE_BIGINT,    8,      GS_FALSE }, // SYS_INDEXPART_COL_ENTRY
    { {.str = (char*)"INITRANS",          .len = 8  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_INITRANS
    { {.str = (char*)"PCTFREE",           .len = 7  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_PCTFREE
    { {.str = (char*)"FLAGS",             .len = 5  }, GS_TYPE_INTEGER,   4,      GS_FALSE }, // SYS_INDEXPART_COL_FLAGS
    { {.str = (char*)"BHIBOUNDVAL",       .len = 11 }, GS_TYPE_BINARY,    4000,   GS_FALSE }, // SYS_INDEXPART_COL_BHIBOUNDVAL
    { {.str = (char*)"BLEVEL",            .len = 6  }, GS_TYPE_BINARY,    4000,   GS_TRUE  }, // SYS_INDEXPART_COL_BLEVEL
    { {.str = (char*)"LEVEL_BLOCKS",      .len = 12 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_LEVEL_BLOCKS
    { {.str = (char*)"DISTKEY",           .len = 7  }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_DISTKEY
    { {.str = (char*)"LBLKKEY",           .len = 7  }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_LBLKKEY
    { {.str = (char*)"DBLKKEY",           .len = 7  }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_DBLKKEY
    { {.str = (char*)"ANALYZETIME",       .len = 11 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_ANALYZETIME
    { {.str = (char*)"EMPTY_LEAF_BLOCKS", .len = 17 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_EMPTY_LEAF_BLOCKS
    { {.str = (char*)"CLUFAC",            .len = 6  }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_CLUFAC
    { {.str = (char*)"SAMPLESIZE",        .len = 10 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_SAMPLESIZE
    { {.str = (char*)"COMB_COLS_2_NDV",   .len = 15 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_COMB_COLS_2_NDV
    { {.str = (char*)"COMB_COLS_3_NDV",   .len = 15 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_COMB_COLS_3_NDV
    { {.str = (char*)"COMB_COLS_4_NDV",   .len = 15 }, GS_TYPE_INTEGER,   4,      GS_TRUE  }, // SYS_INDEXPART_COL_COMB_COLS_4_NDV
    { {.str = (char*)"SUBPART_CNT",       .len = 11 }, GS_TYPE_INTEGER,   4,      GS_FALSE } // SYS_INDEXPART_COL_SUBPART_CNT
};

text_t g_sys_indexpart_idx01_cols[] = {
    {.str = (char*)"USER#",        .len = 5  },
    {.str = (char*)"TABLE#",       .len = 6  },
    {.str = (char*)"INDEX_ID",     .len = 8  },
    {.str = (char*)"PART_ID",      .len = 7  }
};

#define SYS_INDEXPART_COL_COUNT       (sizeof(g_sys_indexpart_cols) / sizeof(column_def_t))
#define SYS_INDEXPART_IDX01_COL_COUNT (sizeof(g_sys_indexpart_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_indexpart_indexes[] = {
    {{.str = (char *)"IX_SYS_INDEXPART001_ID", .len = 19},
        g_sys_indexpart_idx01_cols,
        SYS_INDEXPART_IDX01_COL_COUNT,
        GS_TRUE}};

//SYS_LOGIN_USER
column_def_t g_sys_login_user_cols[] = {
    { {.str = (char*)"USERNAME#",  .len = 9  }, GS_TYPE_VARCHAR,    64,      GS_FALSE }, // SYS_LOGIN_USER_COL_USERNAME_ID
    { {.str = (char*)"PASSWORD#",  .len = 9  }, GS_TYPE_VARCHAR,    64,      GS_FALSE }, // SYS_LOGIN_USER_COL_PASSWORD_ID
 
};
 
text_t g_sys_login_user_idx01_cols[] = {
    {.str = (char*)"USERNAME#", .len = 9  },
};
 
static index_def_t g_sys_log_user_indexes[] = {
    {{.str = (char *)"IX_SYS_LOGIN_USER001_ID", .len = 17},
        g_sys_login_user_idx01_cols,
        SYS_IDX_COL_COUNT(g_sys_login_user_idx01_cols),
        GS_TRUE}};

//SYS_KV
column_def_t g_sys_kv_cols[] = {
    { {.str = (char*)"KEY",  .len = 3  }, GS_TYPE_VARCHAR,    4000,      GS_FALSE },
    { {.str = (char*)"VALUE",  .len = 5  }, GS_TYPE_CLOB,    4000,      GS_TRUE },
};

text_t g_sys_kv_idx01_cols[] = {
    {.str = (char*)"KEY", .len = 3  },
};

static index_def_t g_sys_kv_indexes[] = {
        {{.str = (char*)"IX_SYS_KV_001", .len = 3}, (text_t*)&g_sys_kv_idx01_cols, 1, GS_TRUE}
    };

// SYS_LOBPART
column_def_t g_sys_lobpart_cols[] = {
    { {.str = (char*)"USER#",      .len = 5  }, GS_TYPE_INTEGER, 4,  GS_FALSE },
    { {.str = (char*)"TABLE#",     .len = 6  }, GS_TYPE_INTEGER, 4,  GS_FALSE },
    { {.str = (char*)"COLUMN#",    .len = 7  }, GS_TYPE_INTEGER, 4,  GS_FALSE },
    { {.str = (char*)"PART#",      .len = 5  }, GS_TYPE_INTEGER, 4,  GS_FALSE },
...
text_t g_sys_lobpart_idx01_cols[] = {
    {.str = (char*)"USER#",   .len = 5 },
    {.str = (char*)"TABLE#",  .len = 6 },
    {.str = (char*)"COLUMN#", .len = 7 },
    {.str = (char*)"PART#",   .len = 5 }
...
#define SYS_LOBPART_COL_COUNT       (sizeof(g_sys_lobpart_cols) / sizeof(column_def_t))
#define SYS_LOBPART_IDX01_COL_COUNT (sizeof(g_sys_lobpart_idx01_cols) / sizeof(text_t))

static index_def_t g_sys_lobpart_indexes[] = {
    { {.str = (char*)"IX_LOBPART$001", .len = 10 }, g_sys_lobpart_idx01_cols, SYS_LOBPART_IDX01_COL_COUNT, GS_FALSE }
};

#pragma pack(1)
struct VARCHAR_DEFAULT {
    uint8_t type;
    uint32_t size;
    char data;
};
...
struct INT_DEFAULT int_default_0 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_INTEGER_SIZE, .data = 0}; 
struct INT_DEFAULT int_default_10 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_INTEGER_SIZE, .data = 10}; 
struct INT_DEFAULT int_default_300 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_INTEGER_SIZE, .data = 300}; 
struct INT_DEFAULT int_default_1 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_INTEGER_SIZE, .data = 1}; 
struct INT_DEFAULT int_default_3 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_INTEGER_SIZE, .data = 3}; 
struct BIGINT_DEFAULT bigint_default_0 = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = GS_BIGINT_SIZE, .data = 0}; 
struct VARCHAR_DEFAULT varchar_default = {.type = DEFAULT_VALUE_TYPE_LITERAL, .size = 0, .data = NULL}; 
...
static inline status_t build_ctrlfile(knl_session_t *session, char *home, galist_t *list)
{
    ...
    while (file_name.len > 0)
    {
        ...
        ctrl_file->len = GS_FILE_NAME_BUFFER_SIZE;
        if (file_name.len <= GS_FILE_NAME_BUFFER_SIZE)
        {
            cm_text_copy(ctrl_file, &file_name);
        }
        else
        {
            GS_LOG_RUN_ERR("error control file = %s \n", file_name.str);
        }
        db_fetch_ctrlfile_name(&temp_ctrlfiles, &file_name);
    }
    /*text_t *ctrl_file = NULL;
...
static status_t build_create_database_def(knl_session_t *session, char *home, knl_database_def_t *def)
{
    ...
    instance_t *cc_instance = kernel->server;
    int64 space_size = (int64)cc_instance->attr.space_size;
    ...
    strcpy(def->sys_password, kernel->attr.sys_pwd);

    // ctrl file
    GS_RETURN_IFERR(build_ctrlfile(session, home, &def->ctrlfiles));
    // log file
    GS_RETURN_IFERR(build_space_datafile(session, home, &def->logfiles, "redo", DEFAULT_LOG_FILE, 
            cc_instance->attr.redo_space_size, GS_FALSE));
    // SYSTEM
    GS_RETURN_IFERR(
        build_space_datafile(session, home, &def->system_space.datafiles, "system", 1,
            cc_instance->attr.system_space_size, GS_TRUE));
    // UNDO
    GS_RETURN_IFERR(build_space_datafile(session, home, &def->undo_space.datafiles, "undo", 1,
            cc_instance->attr.undo_space_size, GS_TRUE));
    // DEFAULT
    GS_RETURN_IFERR(build_space_datafile(
        session, home, &def->user_space.datafiles, "user", DEFAULT_USER_FILE,
            cc_instance->attr.user_space_size, GS_TRUE));
    // TEMPORARY
    GS_RETURN_IFERR(build_space_datafile(
        session, home, &def->swap_space.datafiles, "swap", DEFAULT_SWAP_FILE,
            cc_instance->attr.swap_space_size, GS_TRUE));
    // SYSAUX
    GS_RETURN_IFERR(
        build_space_datafile(session, home, &def->sysaux_space.datafiles, "sysaux", 1, space_size, GS_FALSE));
    def->arch_mode = session->kernel->attr.arch_mode;
    return GS_SUCCESS;
}

static status_t build_sys_seq_object(knl_session_t *session) {
    // 2024-9-19
    // CREATE SYS SEQUENCE
    knl_sequence_def_t seq_def;
    seq_def.user = g_user;
    seq_def.name = SEQ_OBJECT_ID;
    seq_def.step = SEQ_OBJECT_ID_STEP;
    seq_def.min_value = SEQ_OBJECT_ID_MINVALUE;
    seq_def.max_value = GS_MAX_INT64;
    if (knl_create_sequence(session, &seq_def) != GS_SUCCESS) {
        return GS_ERROR;
    }
    return GS_SUCCESS;
}
...
status_t knl_create_sys_database(knl_session_t *knl_session, char *home)
{
    ...
    // 2024-9-24
    if (build_sys_seq_object(knl_session) != GS_SUCCESS) {
        return GS_ERROR;
    }
    return GS_SUCCESS;
}
...
static status_t build_table_def(knl_session_t *session, table_def_t *table_def, knl_table_def_t *def)
{
    ...
    def->cr_mode = CR_PAGE;
    def->options |= CREATE_IF_NOT_EXISTS;
    def->is_memory = table_def->is_memory;
    ...
    for (uint32 i = 0; i < table_def->col_count; i++) {
        ...
        column->primary = table_def->cols[i].is_primary;
        column->is_default = table_def->cols[i].is_default;
        column->is_default_null = GS_TRUE;
        column->is_serial = table_def->cols[i].is_autoincrement;
        if (column->is_default){
            column->default_text.str = table_def->cols[i].default_val.str;
            column->default_text.len = table_def->cols[i].default_val.len;
            column->is_default_null = GS_FALSE;
        }
        if (column->comment.len > 0){
            column->is_comment = GS_TRUE;
            column->comment = table_def->cols[i].comment;
        }
        if (column->typmod.datatype == GS_TYPE_DECIMAL || column->typmod.datatype == GS_TYPE_NUMBER){
            column->typmod.precision = table_def->cols[i].precision;
            column->typmod.scale = table_def->cols[i].scale;
        }
    }

    // constraints
    for (uint32 i = 0; i < table_def->cons_count; i++) {
        ...
        MEMS_RETURN_IFERR(memcpy_s(constra, sizeof(knl_constraint_def_t), &table_def->constraints[i], sizeof(knl_constraint_def_t)));
    }
    return GS_SUCCESS;
}
...
static table_def_t g_sys_tables[] = {
    ...
    {{.str = (char *)"SYS_VIEWS", .len = 9},
        ...
        g_sys_views_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_VIEWCOLS", .len = 12},
        g_sys_viewcol_cols,
        SYS_VIEWCOL_COL_COUNT,
        (text_t *)&g_system,
        SYS_VIEWCOL_ID,
        1,
        g_sys_viewcol_indexes,
        TABLE_TYPE_HEAP},
    ...
    {{.str = (char *)"SYS_PRIVS", .len = 9},
        ...
        g_sys_privs_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_COMMENT", .len = 11},
        g_sys_comment_cols,
        SYS_COMMENT_COL_COUNT,
        (text_t *)&g_system,
        SYS_COMMENT_ID,
        1,
        g_sys_comment_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_SEQUENCE", .len = 12},
        g_sys_sequence_cols,
        SYS_SEQUENCE_COL_COUNT,
        (text_t *)&g_system,
        SYS_SEQ_ID,
        1,
        g_sys_sequence_indexes,
        TABLE_TYPE_HEAP},    
    ...
    {{.str = (char *)"SYS_INSTANCE_INFO", .len = 17},
        ...
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_TRIGGER", .len = 11},
        g_sys_trigger_cols,
        SYS_TRIGGER_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_TRIGGER_ID,
        1,
        g_sys_trigger_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_PARTOBJECT", .len = 14},
        g_sys_partobject_cols,
        SYS_PARTOBJECT_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_PARTOBJECT_ID,
        1,
        g_sys_partobject_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_PARTSTORE", .len = 13},
        g_sys_partstore_cols,
        SYS_PARTSTORE_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_PARTSTORE_ID,
        1,
        g_sys_partstore_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_PARTCOLUMN", .len = 14},
        g_sys_partcolumn_cols,
        SYS_PARTCOLUMN_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_PARTCOLUMN_ID,
        1,
        g_sys_partcolumn_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_COMPRESS", .len = 12},
        g_sys_compress_cols,
        SYS_COMPRESS_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_COMPRESS_ID,
        1,
        g_sys_compress_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_INDEXPART", .len = 13},
        g_sys_indexpart_cols,
        SYS_INDEXPART_COL_COUNT,
        (text_t *)&g_sysaux,
        SYS_INDEXPART_ID,
        1,
        g_sys_indexpart_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_KV", .len = 6},
        g_sys_kv_cols,
        SYS_COL_COUNT(g_sys_kv_cols),
        (text_t *)&g_system,
        SYS_KV_ID,
        1,
        g_sys_kv_indexes,
        TABLE_TYPE_HEAP},
    {{.str = (char *)"SYS_LOBPART", .len = 11},
        g_sys_lobpart_cols,
        SYS_COL_COUNT(g_sys_lobpart_cols),
        (text_t *)&g_system,
        SYS_LOBPART_ID,
        1,
        g_sys_lobpart_indexes,
        TABLE_TYPE_HEAP},    
};
...
uint32 knl_get_sys_tables_count(knl_session_t *session) {
    return sizeof(g_sys_tables) / sizeof(table_def_t);
}

table_def_t * knl_get_sys_tabledef_by_idx(knl_session_t *session, uint32 idx) {
    if (idx >= (sizeof(g_sys_tables) / sizeof(table_def_t))) {
        return NULL;
    }
    return &g_sys_tables[idx];
}
