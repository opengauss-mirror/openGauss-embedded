...
void rm_pool_deinit(struct st_instance *cc_instance, rm_pool_t *rm_pool);
status_t knl_alloc_rm(struct st_instance *cc_instance, uint16 *rmid);
void knl_release_rm(struct st_instance *cc_instance, uint16 rmid);
...
uint16 knl_get_xa_xid(struct st_instance *cc_instance, knl_xa_xid_t *xa_xid);
bool32 knl_add_xa_xid(struct st_instance *cc_instance, knl_xa_xid_t *xa_xid, uint16 rmid, uint8 status);
void knl_delete_xa_xid(struct st_instance *cc_instance, knl_xa_xid_t *xa_xid);
