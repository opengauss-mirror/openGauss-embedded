...
#define DEFAULT_DBWR_PROCESSES (uint32)4
#define DEFAULT_UNDO_RETENTION_TIME (uint32)20
#define DEFAULT_UNDO_AUTON_TRANS_SEGMENTS (uint32)1
#define DEFAULT_TX_ROLLBACK_PROC_NUM (uint32)2
#define DEFAULT_MAX_ARCH_FILES_SIZE (uint32)SIZE_G(16)
#define DEFAULT_EXTENTS (uint32)32
...
#define DEFAULT_CKPT_TIMEOUT (uint32)1
#define DEFAULT_PAGE_CLEAN_PERIOD (uint32)1000
...
#define DEFAULT_DBWR_FSYNC_TIMEOUT (uint32)100  // millisecond
