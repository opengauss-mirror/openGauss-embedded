...
EXPORT_API void sha256_init(SHA256_CTX *ctx);
EXPORT_API void sha256_update(SHA256_CTX *ctx, const uint8_t* data, size_t datalen);
EXPORT_API void sha256_finish(SHA256_CTX *ctx, uint8_t dgst[SHA256_DIGEST_SIZE]);
EXPORT_API void sha256_digest(const uint8_t *data, size_t datalen,
