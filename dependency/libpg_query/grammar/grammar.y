...
{{{ GRAMMAR_HEADER }}}
%}
#line 5 "dependency/libpg_query/grammar/grammar.y"
%pure-parser
%expect 0
%name-prefix="base_yy"
%locations
...
%token			LESS_EQUALS GREATER_EQUALS NOT_EQUALS EQUALS
...
%left   '=' NOT_EQUALS LIKE ILIKE SIMILAR NOT_LA EQUALS
%nonassoc	BETWEEN IN_P GLOB
...
%left		OPERATOR		/* multi-character ops and user-defined operators */
%left		'+' '-'
%left		'*' '/' '%'
%left		'^' POWER_OF
/* Unary Operators */
