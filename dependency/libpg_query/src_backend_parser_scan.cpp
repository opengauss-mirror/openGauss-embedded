#line 1 "dependency/libpg_query/src_backend_parser_scan.cpp"
/*-------------------------------------------------------------------------
 *
 * scan.l
...
#line 43 "dependency/libpg_query/src_backend_parser_scan.cpp"
...
static const flex_int16_t yy_accept[297] =
    {   0,
       ...
       26,   26,   27,   27,   35,   36,   35,    1,   73,   70,
       43,   74,   44,   65,    1,   63,   61,   77,    2,   77,

       76,   80,   60,   62,   67,   69,   71,   66,   68,   75,
...
static const flex_int16_t yy_base[364] =
    {   0,
      ...
      349,   80,   50,   81,   83,  339,   89,    0,  338,  337,
     ...
     1215,  116,  278,    0,  226,  262, 1215,  155,    0,  170,

      175,  188, 1215, 1215,    0,    0,    0,    0,    0,  133,
     ...
     1215,  200,  151,  204, 1215, 1215,  289, 1215,  223,  298,
      ...
      122,  569,    0,   94,    0,    0,   55,  578,   42,  583,
...
static const flex_int16_t yy_def[364] =
    {   0,
      ...
      296,  296,  319,  307,  320,  307,  296,  296,  321,  296,

      296,  296,  296,  296,  307,  307,  307,  307,  307,  296,
...
static const flex_int16_t yy_nxt[1254] =
    {   0,
       ...
       72,   57,   57,   95,  272,   58,   57,   57,  103,   59,
      104,   96,   87,   57,   57,   57,   67,   57,   88,   88,
       88,   87,   88,   88,   88,   67,   75,   76,   75,   91,
       97,  122,   98,   98,  100,  123,  101,  101,   77,   92,

       92,  105,  106,  107,  108,  110,  110,  270,  102,  145,
      ...
      145,  145,  145,  102,  161,  251,  162,  162,  249,  100,
       84,  101,  101,   84,   81,   82,   81,  241,  102,  235,

      163,  163,  215,  102,  164,  164,   83,  118,  119,  119,
      167,  167,  167,  128,  129,  129,  162,  162,  168,  120,
      164,  164,  169,  211,  210,  130,   84,  143,  102,   84,
      ...
      119,  119,  196,  119,  119,  197,  224,  225,  225,  109,
       99,  197,   94,   90,  222,  200,  129,  129,  226,  200,
...
static const flex_int16_t yy_chk[1254] =
    {   0,
      ...
      145,  145,  145,   98,  100,  241,  100,  100,  235,  101,
       23,  101,  101,   23,   24,   24,   24,  215,  100,  210,

      102,  102,  191,  101,  102,  102,   24,  118,  118,  118,
      ...
      196,  196,  197,  197,  197,  195,  198,  198,  198,   46,
       41,  196,   38,   31,  197,  199,  199,  199,  198,  200,
...
#line 1 "dependency/libpg_query/scan.l"

#line 46 "dependency/libpg_query/scan.l"
...
#line 1152 "dependency/libpg_query/src_backend_parser_scan.cpp"
 ...
 */
#line 1306 "dependency/libpg_query/src_backend_parser_scan.cpp"
...
YY_DECL
{
	...
	{
#line 404 "dependency/libpg_query/scan.l"


#line 1595 "dependency/libpg_query/src_backend_parser_scan.cpp"
...
YY_RULE_SETUP
#line 406 "dependency/libpg_query/scan.l"
{
					/* ignore */
				}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 410 "dependency/libpg_query/scan.l"
{
...
case 3:
YY_RULE_SETUP
#line 419 "dependency/libpg_query/scan.l"
{
					(yyextra->xcdepth)++;
					/* Put back any characters past slash-star; see above */
					yyless(2);
...
case 4:
YY_RULE_SETUP
#line 425 "dependency/libpg_query/scan.l"
{
...
YY_RULE_SETUP
#line 432 "dependency/libpg_query/scan.l"
{
					/* ignore */
				}
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 436 "dependency/libpg_query/scan.l"
{
					/* ignore */
				}
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 440 "dependency/libpg_query/scan.l"
{
					/* ignore */
				}
	YY_BREAK
case YY_STATE_EOF(xc):
#line 444 "dependency/libpg_query/scan.l"
{ yyerror("unterminated /* comment"); }
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 446 "dependency/libpg_query/scan.l"
{
					/* Binary bit type.
...
#line 459 "dependency/libpg_query/scan.l"
case 10:
...
#line 466 "dependency/libpg_query/scan.l"
case 12:
...
#line 470 "dependency/libpg_query/scan.l"
case 14:
...
#line 473 "dependency/libpg_query/scan.l"
{ yyerror("unterminated bit string literal"); }
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 475 "dependency/libpg_query/scan.l"
{
...
#line 488 "dependency/libpg_query/scan.l"
case 17:
...
#line 494 "dependency/libpg_query/scan.l"
{ yyerror("unterminated hexadecimal string literal"); }
	YY_BREAK
case 18:
YY_RULE_SETUP
#line 496 "dependency/libpg_query/scan.l"
{
					/* National character.
...
case 19:
YY_RULE_SETUP
#line 522 "dependency/libpg_query/scan.l"
{
...
case 20:
YY_RULE_SETUP
#line 532 "dependency/libpg_query/scan.l"
{
...
case 21:
YY_RULE_SETUP
#line 539 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					if (!yyextra->standard_conforming_strings)
						ereport(ERROR,
...
#line 551 "dependency/libpg_query/scan.l"
case 23:
...
#line 566 "dependency/libpg_query/scan.l"
case 25:
...
YY_RULE_SETUP
#line 572 "dependency/libpg_query/scan.l"
{
					/* stay in xusend state over whitespace */
				}
	YY_BREAK
case YY_STATE_EOF(xusend):
#line 575 "dependency/libpg_query/scan.l"
case 27:
/* rule 27 can match eol */
#line 577 "dependency/libpg_query/scan.l"
case 28:
...
YY_RULE_SETUP
#line 584 "dependency/libpg_query/scan.l"
{
...
case 30:
YY_RULE_SETUP
#line 597 "dependency/libpg_query/scan.l"
{
...
YY_RULE_SETUP
#line 600 "dependency/libpg_query/scan.l"
{
					addlit(yytext, yyleng, yyscanner);
				}
	YY_BREAK
...
YY_RULE_SETUP
#line 603 "dependency/libpg_query/scan.l"
{
					addlit(yytext, yyleng, yyscanner);
				}
	YY_BREAK
case 33:
YY_RULE_SETUP
#line 606 "dependency/libpg_query/scan.l"
{
...
case 34:
YY_RULE_SETUP
#line 621 "dependency/libpg_query/scan.l"
{
					pg_wchar	c = strtoul(yytext + 2, NULL, 16);
...
case 35:
YY_RULE_SETUP
#line 633 "dependency/libpg_query/scan.l"
{ yyerror("invalid Unicode surrogate pair"); }
	YY_BREAK
case 36:
/* rule 36 can match eol */
YY_RULE_SETUP
#line 634 "dependency/libpg_query/scan.l"
{ yyerror("invalid Unicode surrogate pair"); }
	YY_BREAK
case YY_STATE_EOF(xeu):
#line 635 "dependency/libpg_query/scan.l"
{ yyerror("invalid Unicode surrogate pair"); }
	YY_BREAK
case 37:
YY_RULE_SETUP
#line 636 "dependency/libpg_query/scan.l"
{
					ereport(ERROR,
...
YY_RULE_SETUP
#line 643 "dependency/libpg_query/scan.l"
{
					// if (yytext[1] == '\'')
					// {
...
case 39:
YY_RULE_SETUP
#line 659 "dependency/libpg_query/scan.l"
{
...
case 40:
YY_RULE_SETUP
#line 667 "dependency/libpg_query/scan.l"
{
...
YY_RULE_SETUP
#line 675 "dependency/libpg_query/scan.l"
{
					/* ignore */
				}
	YY_BREAK
case 42:
YY_RULE_SETUP
#line 678 "dependency/libpg_query/scan.l"
{
...
#line 682 "dependency/libpg_query/scan.l"
{ yyerror("unterminated quoted string"); }
	YY_BREAK
case 43:
YY_RULE_SETUP
#line 684 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 44:
YY_RULE_SETUP
#line 690 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 45:
YY_RULE_SETUP
#line 697 "dependency/libpg_query/scan.l"
{
...
YY_RULE_SETUP
#line 717 "dependency/libpg_query/scan.l"
{
					addlit(yytext, yyleng, yyscanner);
				}
	YY_BREAK
case 47:
YY_RULE_SETUP
#line 720 "dependency/libpg_query/scan.l"
{
					addlit(yytext, yyleng, yyscanner);
				}
	YY_BREAK
case 48:
YY_RULE_SETUP
#line 723 "dependency/libpg_query/scan.l"
{
...
#line 727 "dependency/libpg_query/scan.l"
{ yyerror("unterminated dollar-quoted string"); }
	YY_BREAK
case 49:
YY_RULE_SETUP
#line 729 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					BEGIN(xd);
					startlit();
...
case 50:
YY_RULE_SETUP
#line 734 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					BEGIN(xui);
					startlit();
...
case 51:
YY_RULE_SETUP
#line 739 "dependency/libpg_query/scan.l"
{
					char	   *ident;
...
case 52:
YY_RULE_SETUP
#line 749 "dependency/libpg_query/scan.l"
{
					yyless(1);
...
YY_RULE_SETUP
#line 754 "dependency/libpg_query/scan.l"
{
					/* stay in xuiend state over whitespace */
				}
	YY_BREAK
case YY_STATE_EOF(xuiend):
#line 757 "dependency/libpg_query/scan.l"
case 54:
/* rule 54 can match eol */
#line 759 "dependency/libpg_query/scan.l"
case 55:
...
YY_RULE_SETUP
#line 772 "dependency/libpg_query/scan.l"
{
					/* found UESCAPE after the end quote */
					char	   *ident;
...
case 57:
YY_RULE_SETUP
#line 789 "dependency/libpg_query/scan.l"
{
					addlitchar('"', yyscanner);
				}
	YY_BREAK
...
YY_RULE_SETUP
#line 792 "dependency/libpg_query/scan.l"
{
					addlit(yytext, yyleng, yyscanner);
				}
	YY_BREAK
...
#line 795 "dependency/libpg_query/scan.l"
{ yyerror("unterminated quoted identifier"); }
	YY_BREAK
case 59:
YY_RULE_SETUP
#line 797 "dependency/libpg_query/scan.l"
{
					char	   *ident;
...
case 60:
YY_RULE_SETUP
#line 809 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return TYPECAST;
				}
...
case 61:
YY_RULE_SETUP
#line 814 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return DOT_DOT;
				}
...
case 62:
YY_RULE_SETUP
#line 819 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return COLON_EQUALS;
				}
...
case 63:
YY_RULE_SETUP
#line 824 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return LAMBDA_ARROW;
				}
...
case 64:
YY_RULE_SETUP
#line 829 "dependency/libpg_query/scan.l"
{
                    SET_YYLLOC();
                    return DOUBLE_ARROW;
                		}
...
case 65:
YY_RULE_SETUP
#line 834 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return POWER_OF;
				}
...
case 66:
YY_RULE_SETUP
#line 839 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 67:
YY_RULE_SETUP
#line 844 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return LESS_EQUALS;
				}
...
case 68:
YY_RULE_SETUP
#line 849 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 69:
YY_RULE_SETUP
#line 854 "dependency/libpg_query/scan.l"
{
...
case 70:
YY_RULE_SETUP
#line 860 "dependency/libpg_query/scan.l"
{
					/* We accept both "<>" and "!=" as meaning NOT_EQUALS */
					SET_YYLLOC();
					return NOT_EQUALS;
...
case 71:
YY_RULE_SETUP
#line 866 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return EQUALS;
				}
...
case 72:
YY_RULE_SETUP
#line 871 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return yytext[0];
				}
...
case 73:
YY_RULE_SETUP
#line 876 "dependency/libpg_query/scan.l"
{
					/*
...
case 74:
YY_RULE_SETUP
#line 995 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 75:
YY_RULE_SETUP
#line 1001 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					yylval->ival = atol(yytext + 1);
					return PARAM;
...
case 76:
YY_RULE_SETUP
#line 1007 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
...
case 77:
YY_RULE_SETUP
#line 1011 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					yylval->str = pstrdup(yytext);
					return FCONST;
...
case 78:
YY_RULE_SETUP
#line 1016 "dependency/libpg_query/scan.l"
{
...
case 79:
YY_RULE_SETUP
#line 1022 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					yylval->str = pstrdup(yytext);
					return FCONST;
...
case 80:
YY_RULE_SETUP
#line 1027 "dependency/libpg_query/scan.l"
{
					/*
...
case 81:
YY_RULE_SETUP
#line 1039 "dependency/libpg_query/scan.l"
{
...
case 82:
YY_RULE_SETUP
#line 1048 "dependency/libpg_query/scan.l"
{
					const PGScanKeyword *keyword;
					char	   *ident;
...
case 83:
YY_RULE_SETUP
#line 1081 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					return yytext[0];
				}
...
#line 1086 "dependency/libpg_query/scan.l"
{
					SET_YYLLOC();
					yyterminate();
				}
...
case 84:
YY_RULE_SETUP
#line 1091 "dependency/libpg_query/scan.l"
YY_FATAL_ERROR( "flex scanner jammed" );
	YY_BREAK
#line 2668 "dependency/libpg_query/src_backend_parser_scan.cpp"
